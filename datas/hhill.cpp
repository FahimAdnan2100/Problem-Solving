...
int main()
{
    ...
    for(int i = 0; i < 3; i++)
    {
        determinant = determinant + (q[0][i] * (q[1][(i+1)%3] * q[2][(i+2)%3] - q[1][(i+2)%3] * q[2][(i+1)%3]));
    ...
    for(int i = 0; i < 3; i++)
    {
        for(int j = 0; j < 3; j++)
        {
            cout<<((q[(j+1)%3][(i+1)%3] * q[(j+2)%3][(i+2)%3]) - (q[(j+1)%3][(i+2)%3] * q[(j+2)%3][(i+1)%3]))/ determinant<<"\t";
        }
        cout<<endl;
    }
